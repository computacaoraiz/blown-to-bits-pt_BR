...
universitária com GPA de 3,5\footnote{[NT] GPA, do inglês \ingles{Grade Point
Average}, é um número que indica o rendimento, o aproveitamento acadêmico nas
...
Nicolette queria saber o que havia feito de errado, mas ninguém conseguia 
...
Muitos outros sistemas estão hoje fazendo julgamentos semelhantes em outros 
...
após a Segunda Guerra Mundial, ele escreveu o artigo seminal ``\ingles{A
Mathematical Theory of Communication}'', que antecipou grande parte do
...
Apresentamos sete verdades sobre bits. Chamamos de ``koans'' porque são
