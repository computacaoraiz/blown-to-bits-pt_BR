...
corredora amadora Rosie Spinks é uma história de bits. Spinks usava um
...
configuração de ``Privacidade Aprimorada'' do aplicativo. Mas quando
estranhos começaram a ``curtir'' seus treinos enquanto ela estava viajando para
o exterior, ela percebeu que a ``Privacidade Aprimorada'', na verdade,
significava ``contar para homens aleatórios sobre meus treinos se eu estiver na
lista dos melhores''. O aplicativo de condicionamento físico também era um
aplicativo de rede social, e os dados de Rosie estavam sendo
comercializados\footnote{Rosie Spinks, ``Confused About How to Use Strava
...
vezes. Todos os dias, os vídeos enviados para o YouTube são suficientes para
...
``registro público'', agora, é \textbf{muito} público. Antes de ser contratado
